...
<div class="auth-split-wrapper">
  <!-- Left: Image Section -->
  <div class="auth-side-image" style="background-image: url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1200&q=80');">
    <div class="auth-image-content">
      <h2 class="auth-image-title">Keep it <span class="text-white opacity-75">secure.</span></h2>
      <p class="fs-5 opacity-75">Choose a strong password to protect your personal browser workspace and data.</p>
    </div>
  </div>
